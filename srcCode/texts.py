...
class Texts():
    ...
    def text2(self):
        text2 = '''
            ...
            2,1,3-Benzothiadiazole (BTD) derivatives show promise in advanced photophysical applications, but designing molecules with optimal desidred properties remains challenging due to complex structure-property relationships. Existing computational methods have a time consuming to predict precise photophyscal characteristics.  Machine learning with Morgan fingerprints was emplyed to forecast BTD derivatives maximum absorption and emission wavelengths. Three flavor of machine models were applied, namely Random Forest, LigthGBM and XGBoost. Random forest achieved $R^2$ values of 0.92 for absorption and 0.89 for emission, validated internally with 10 folds cross-validations and externally with recent experimental data. SHAP analysis revealed critical design insights, highlighting tertiary amine presence and solvent polarity as key drivers of red-shifted emissions. By developing a web-based predictive tool, we demonstrate machine learning's potential to accelerate molecular design, providing researchers a powerful approach to engineer BTD derivatives with enhanced photophysical properties.
            </div>
        '''
        return text2
